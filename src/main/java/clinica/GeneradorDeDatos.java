...
public class GeneradorDeDatos {
    ...
    public static void crearDoctoresEspecialidadesYPrestaciones(ArrayList<Doctor> doctores, ArrayList<Prestacion> prestaciones, ArrayList<Especialidad> especialidades, ArrayList<Ubicacion> ubicaciones) {
        ...
        Ubicacion ubicacionA = new Consultorio("Consultorio 01") {
        };
        Laboratorio ubicacionB = new Laboratorio("Laboratorio 01") {
        };
        Ubicacion ubicacionC = new Consultorio("Consultorio 03") {
        };
        Ubicacion ubicacionD = new Consultorio("Consultorio 04") {
        };
        Ubicacion ubicacionE = new Consultorio("Consultorio 05") {
        };
        Ubicacion ubicacionF = new Consultorio("Consultorio 06") {
        };
        Ubicacion ubicacionG = new Consultorio("Consultorio 07") {
        };
        Ubicacion ubicacionH = new Consultorio("Consultorio 08") {
        };
        Ubicacion ubicacionI = new Consultorio("Consultorio 09") {
        };
